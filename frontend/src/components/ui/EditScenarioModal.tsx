...
export default function EditScenarioModal({
  ...
  function validateName(value: string): string | null {
    ...
    if (isDuplicate) {
      return `A scenario named "${trimmed}" already exists for this client`;
    }
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md rounded-2xl bg-white p-6 shadow-elevated">
        <div className="mb-4 flex items-center gap-3">
          ...
          <div>
            <h3 className="text-lg font-semibold text-harbor-900">Edit Scenario Name</h3>
            <p className="text-sm text-sage-600">Rename this scenario</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end gap-3">
            ...
            <button
              type="submit"
              disabled={isPending || !!validationError || !name.trim()}
